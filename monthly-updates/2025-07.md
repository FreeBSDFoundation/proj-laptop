...
usbhid is has been enabled by default in CURRENT, allowing the use of a much wider range of devices than supported by previous drivers. usbhid will be used in preference to other drivers to support input devices such as mice, keyboards and trackpads.
